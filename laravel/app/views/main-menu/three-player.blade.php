...
@section('content')
	{{ Form::open(array('id'=>'create-three-player-form')) }}
	<div class="center well">
		<div class="row-fluid">
			<div class="span12">
				<h2><i class="cus-ruby padded-h2-icon"></i> Three-Player Game <i class="cus-ruby padded-h2-icon"></i></h2>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span4">
			...
			<div class="span4">
				<label for="player-three"><i class="cus-sport_basketball"></i> Player 3</label>
				{{ Form::text('player-three', 
					Input::old('player-three'), 
					array(
						'maxlength' => '20', 
						'placeholder' => 'Enter Your Name', 
						'class' => HTML::fieldError('player-three', Session::get('messages', ''))
					)) 
				}}	
			</div>
		</div>
