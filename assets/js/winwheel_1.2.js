...
var wheelImageName   = baseUrl+"/assets/img/wheel/wheel-of-fortune-wheel.png";	// File name of the image for the wheel.
//var spinButtonImgOn  = "http://ruddymysterious.com/wheel-of-scouting/assets/img/wheel/spin_on.png";		// Name / path to the images for the spin button.
//var spinButtonImgOff = "http://ruddymysterious.com/wheel-of-scouting/assets/img/wheel/spin_off.png";
...
/*
prizes[0] = {"name" : "$ 1", "startAngle" : 0,   "endAngle" : 44};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "$ 2", "startAngle" : 45,  "endAngle" : 89};
prizes[2] = {"name" : "$ 3", "startAngle" : 90,  "endAngle" : 134};
prizes[3] = {"name" : "$ 4", "startAngle" : 135, "endAngle" : 179};
prizes[4] = {"name" : "$ 5", "startAngle" : 180, "endAngle" : 224};
prizes[5] = {"name" : "$ 6", "startAngle" : 225, "endAngle" : 269};
prizes[6] = {"name" : "$ 7", "startAngle" : 270, "endAngle" : 314};
prizes[7] = {"name" : "$ 8", "startAngle" : 315, "endAngle" : 360};
*/
prizes[0] = {"name" : "300", "startAngle" : 0,   "endAngle" : 14};  // 15 Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "600", "startAngle" : 15,  "endAngle" : 29};
prizes[2] = {"name" : "300", "startAngle" : 30,  "endAngle" : 44};
prizes[3] = {"name" : "500", "startAngle" : 45, "endAngle" : 59};
prizes[4] = {"name" : "800", "startAngle" : 60, "endAngle" : 74};
prizes[5] = {"name" : "550", "startAngle" : 75, "endAngle" : 89};
prizes[6] = {"name" : "400", "startAngle" : 90, "endAngle" : 104};
prizes[7] = {"name" : "300", "startAngle" : 105, "endAngle" : 119};
prizes[8] = {"name" : "900", "startAngle" : 120, "endAngle" : 134};
prizes[9] = {"name" : "500", "startAngle" : 135, "endAngle" : 149};
prizes[10] = {"name" : "300", "startAngle" : 150, "endAngle" : 164};
prizes[11] = {"name" : "900", "startAngle" : 165, "endAngle" : 179};
prizes[12] = {"name" : "BANKRUPT", "startAngle" : 180, "endAngle" : 194};
prizes[13] = {"name" : "600", "startAngle" : 195, "endAngle" : 209};
prizes[14] = {"name" : "400", "startAngle" : 210, "endAngle" : 224};
prizes[15] = {"name" : "300", "startAngle" : 225, "endAngle" : 239};
prizes[16] = {"name" : "LOSE A TURN", "startAngle" : 240, "endAngle" : 254};
prizes[17] = {"name" : "800", "startAngle" : 255, "endAngle" : 269};
prizes[18] = {"name" : "300", "startAngle" : 270, "endAngle" : 284};
prizes[19] = {"name" : "450", "startAngle" : 285, "endAngle" : 299};
prizes[20] = {"name" : "700", "startAngle" : 300, "endAngle" : 314};
prizes[21] = {"name" : "300", "startAngle" : 315, "endAngle" : 329};
prizes[22] = {"name" : "600", "startAngle" : 330, "endAngle" : 344};
prizes[23] = {"name" : "1000", "startAngle" : 345, "endAngle" : 360};
